    ...
    return (
        <div>
            <div className="group relative block overflow-hidden shadow-2xl">
                ...
                {winner && winner?.image ? <div className=""><img title="Profile" className="w-72  md:w-80 lg:w-[400px] h-72  md:h-80 lg:h-[400px] mb-4 mx-auto rounded-full object-cover" src={winner?.image} alt="" /></div> :
                    <div>
                        {
